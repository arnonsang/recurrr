<script lang="ts">
	...
	// Generate default next payment date (30 days from now)
...
<svelte:head>
	<title>Add Subscription - Recurrr</title>
</svelte:head>
...
<div class="container mx-auto max-w-3xl px-4 py-8">
	<div class="mb-8">
		...
		<h1 class="mt-4 text-3xl font-bold">Add New Subscription</h1>
		<p class="mt-2 opacity-70">Track a new recurring subscription or service</p>
	</div>
	...
	<div class="card bg-base-100 shadow-md">
		...
		>
					...
					<div class="form-control">
						...
						>
							...
							{#each data.currencies as currency}
								<option
									value={currency}
									selected={getFieldValue('currency') === currency ||
										(currency === 'THB' && !getFieldValue('currency'))}
								>
									{currency}
								</option>
							{/each}
				...
				<div class="grid grid-cols-1 gap-4 md:grid-cols-3">
					<div class="form-control">
						...
						<input
							...
							min="1"
							max="31"
							value={getFieldValue('paymentDay') || '1'}
					...
					<div class="form-control">
						...
						>
							<option
								value="1"
								selected={getFieldValue('paymentMonth') === '1' || !getFieldValue('paymentMonth')}
								>Monthly (1)</option
							>
					...
					<div class="form-control">
						...
						<input
							...
							name="nextPayment"
							required
							value={getFieldValue('nextPayment') || getDefaultNextPayment()}
			...
			<div class="flex justify-end gap-3">
				<a href="/subscriptions" class="btn btn-ghost">Cancel</a>
